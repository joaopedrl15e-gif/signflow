...
export default function ClinicaUltraDemoPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans selection:bg-cyan-500 selection:text-black pb-32 relative overflow-x-hidden">
      {/* 🩺 THEMED CLINICAL 3D LASER & CYAN GLOW 🩺 */}
      ...
      <div className="fixed top-[-5%] left-[5%] w-[500px] h-[500px] bg-cyan-500/20 rounded-full blur-[140px] pointer-events-none animate-aurora-1 z-0" />
      <div className="fixed top-[30%] right-[5%] w-[550px] h-[550px] bg-blue-600/20 rounded-full blur-[150px] pointer-events-none animate-aurora-2 z-0" />
      <div className="fixed bottom-[10%] left-[10%] w-[600px] h-[600px] bg-teal-500/15 rounded-full blur-[160px] pointer-events-none animate-float-slow z-0" />

      {/* Floating Medical Sparkles */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[30%] left-[15%] w-2.5 h-2.5 rounded-full bg-cyan-400/50 blur-xs animate-ember-1" />
        <div className="absolute top-[55%] right-[20%] w-3 h-3 rounded-full bg-blue-400/40 blur-xs animate-ember-2" />
        <div className="absolute top-[75%] left-[18%] w-2 h-2 rounded-full bg-teal-400/40 blur-xs animate-ember-3" />
        <div className="absolute top-[18%] right-[12%] w-2.5 h-2.5 rounded-full bg-cyan-300/50 blur-xs animate-ember-4" />
      </div>
      {/* 🚀 TOP SELLER BAR 🚀 */}
