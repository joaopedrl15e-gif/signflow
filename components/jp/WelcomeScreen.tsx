...
const GlowingIcon: React.FC<{ Icon: React.ElementType }> = ({ Icon }) => (
  <div className="relative group hover:scale-110 transition-transform duration-300">
    ...
    <div className="relative p-3 sm:p-4 bg-black/50 backdrop-blur-sm rounded-full border border-white/10 shadow-xl">
...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onLoadingComplete }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] bg-[#030014] flex items-center justify-center transition-all duration-700 ${
        ...
        <div className="w-full max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
          ...
          <div className="text-center mb-6 sm:mb-8 space-y-2 sm:space-y-4">
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold tracking-tight">
              ...
              <div className="space-x-2">
                <span className="inline-block px-1.5 sm:px-2 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent font-extrabold">
                  Portfolio
                </span>
                <span className="inline-block px-1.5 sm:px-2 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent font-extrabold">
                  Website
          ...
          <div className="text-center pt-2 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 sm:px-7 sm:py-3.5 rounded-full relative group hover:scale-105 transition-transform duration-300 cursor-pointer">
              ...
              <div className="relative flex items-center gap-2 text-base sm:text-xl md:text-2xl font-mono">
                <Globe className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-400" />
                <span className="bg-gradient-to-r from-indigo-500 via-purple-400 to-pink-400 bg-clip-text text-transparent font-bold">
