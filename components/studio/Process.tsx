  ...
  return (
    <section className="py-24 px-4 sm:px-6 max-w-6xl mx-auto relative z-10">
      ...
      <div className="relative">
        <div className="hidden lg:block absolute top-1/2 left-8 right-8 h-0.5 bg-gradient-to-r from-purple-600 via-indigo-500 to-cyan-400 -translate-y-6 opacity-30 z-0" />

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
          {STEPS.map((step, idx) => (
            <div
              key={idx}
              className="p-6 rounded-3xl bg-[#0a0526]/90 border border-purple-500/20 hover:border-cyan-400/50 transition-all duration-300 flex flex-col justify-between space-y-4 group shadow-xl hover:shadow-purple-950/40 hover:-translate-y-1"
            >
