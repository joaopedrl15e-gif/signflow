...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-white text-slate-800 flex flex-col border-r border-slate-200/90 min-h-screen shrink-0 shadow-sm relative z-30">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="px-1.5 py-0.5 rounded bg-emerald-100 text-emerald-800 text-[10px] font-extrabold tracking-wider border border-emerald-200">
                PRO
              </span>
            </div>
      ...
      {/* Plan Card */}
      <div className="p-4 m-3 rounded-2xl bg-gradient-to-b from-slate-50 to-slate-100 border border-slate-200/80 text-center relative overflow-hidden">
        ...
        <p className="text-[11px] text-slate-500 text-left mb-3">
          Propostas e assinaturas sem limites mensais ativas.
        </p>

        <div className="w-full bg-slate-200 h-1.5 rounded-full overflow-hidden mb-1.5">
          <div className="bg-gradient-to-r from-indigo-600 to-emerald-500 h-full w-[70%]" />
        </div>
        <div className="flex justify-between text-[10px] text-slate-500">
          <span>Uso do Sistema</span>
          <span className="text-emerald-700 font-bold">100% Ilimitado</span>
        </div>
      </div>
    </aside>
  );
